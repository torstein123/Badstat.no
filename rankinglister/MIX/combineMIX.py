...
# File path
path = r"C:\Users\Torstein\Documents\rankinglist-master (2)\rankinglist-master\badmintonstats\rankinglister\MIX"
...
final_df.to_csv(os.path.join(path, "combined_rankingsMIX.csv"), index=False)
